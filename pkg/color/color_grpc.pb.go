...
const (
	...
	ColorService_UpdateColor_FullMethodName = "/ColorService/UpdateColor"
	ColorService_GetChaos_FullMethodName    = "/ColorService/GetChaos"
	ColorService_UpdateChaos_FullMethodName = "/ColorService/UpdateChaos"
)
...
type ColorServiceClient interface {
	...
	// Chaos injection via gRPC — keeps all color traffic on port 8000.
	// No separate HTTP chaos sidecar required.
	GetChaos(ctx context.Context, in *ChaosRequest, opts ...grpc.CallOption) (*ChaosState, error)
	UpdateChaos(ctx context.Context, in *ChaosState, opts ...grpc.CallOption) (*ChaosState, error)
}
...
func (c *colorServiceClient) UpdateColor(ctx context.Context, in *ColorUpdate, opts ...grpc.CallOption) (*ColorUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, ColorService_UpdateColor_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *colorServiceClient) GetChaos(ctx context.Context, in *ChaosRequest, opts ...grpc.CallOption) (*ChaosState, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChaosState)
	err := c.cc.Invoke(ctx, ColorService_GetChaos_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *colorServiceClient) UpdateChaos(ctx context.Context, in *ChaosState, opts ...grpc.CallOption) (*ChaosState, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChaosState)
	err := c.cc.Invoke(ctx, ColorService_UpdateChaos_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ColorServiceServer interface {
	...
	// Chaos injection via gRPC — keeps all color traffic on port 8000.
	// No separate HTTP chaos sidecar required.
	GetChaos(context.Context, *ChaosRequest) (*ChaosState, error)
	UpdateChaos(context.Context, *ChaosState) (*ChaosState, error)
...
func (UnimplementedColorServiceServer) Center(context.Context, *ColorRequest) (*ColorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Center not implemented")
}
func (UnimplementedColorServiceServer) Edge(context.Context, *ColorRequest) (*ColorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Edge not implemented")
}
...
func (UnimplementedColorServiceServer) GetChaos(context.Context, *ChaosRequest) (*ChaosState, error) {
	return nil, status.Error(codes.Unimplemented, "method GetChaos not implemented")
}
func (UnimplementedColorServiceServer) UpdateChaos(context.Context, *ChaosState) (*ChaosState, error) {
...
func RegisterColorServiceServer(s grpc.ServiceRegistrar, srv ColorServiceServer) {
	// If the following call panics, it indicates UnimplementedColorServiceServer was
...
func _ColorService_UpdateColor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ColorService_UpdateColor_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ColorService_GetChaos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChaosRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ColorServiceServer).GetChaos(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ColorService_GetChaos_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ColorServiceServer).GetChaos(ctx, req.(*ChaosRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ColorService_UpdateChaos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChaosState)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ColorServiceServer).UpdateChaos(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ColorService_UpdateChaos_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ColorServiceServer).UpdateChaos(ctx, req.(*ChaosState))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ColorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetChaos",
			Handler:    _ColorService_GetChaos_Handler,
		},
		{
			MethodName: "UpdateChaos",
			Handler:    _ColorService_UpdateChaos_Handler,
		},
	},
